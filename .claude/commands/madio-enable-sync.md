...
echo "==============================="
echo ""
echo "🎯 To sync your MADIO documents to Google Docs:"
echo ""
echo "   1. 📁 Create sync directory:"
echo "      mkdir synced_docs"
echo ""
echo "   2. 📄 Move your documents:"
echo "      mv *.md synced_docs/"
echo ""
echo "   3. 🔄 Sync to Google Docs:"
echo "      python .claude/scripts/sync_to_docs.py --directory synced_docs"
echo ""
echo "That's it! Google Docs will be created automatically."
echo ""

echo "🔗 Available Commands:"
echo "   • python .claude/scripts/sync_to_docs.py --directory synced_docs"
echo "   • /sync-status - Check sync health and view Google Doc URLs"
echo "   • /push-to-docs --config - Traditional config-based sync"
echo ""

echo "📊 Advanced Usage:"
echo "   • Pattern matching: --pattern \"tier3_*.md\""
echo "   • Exclude files: --exclude \"test_*.md\""
echo "   • Sync status: /sync-status --verbose"
echo ""

echo "📋 Workflow Integration:"
echo "   • /generate-ai-system → Choose sync option → Files auto-moved to synced_docs/"
echo "   • Edit files locally in synced_docs/"
echo "   • Run sync command whenever you want to update Google Docs"
echo "   • Claude Project automatically sees all changes"
echo ""

echo "💡 Pro Tips:"
echo "   • Files are auto-discovered - just add .md files to synced_docs/"
echo "   • Google Doc URLs are displayed after each sync"
echo "   • Document IDs are saved automatically in .synced_docs_mapping.json"
echo "   • Use /sync-status anytime to check health and get URLs"
echo "   • Progress bars show sync status for multiple files"
echo ""

echo "🔄 Recommended Workflow:"
echo "   1. Generate AI system: /generate-ai-system \"your AI description\""
echo "   2. Choose sync setup: Files move to synced_docs/ automatically"
echo "   3. Sync to Google Docs: python .claude/scripts/sync_to_docs.py --directory synced_docs"
echo "   4. Future edits: Edit locally → run sync command → see changes in Google Docs"
echo ""

echo "🏥 Health Monitoring:"
echo "   • Run /sync-status for comprehensive health check"
echo "   • Check sync score and get recommendations"
echo "   • View all Google Doc URLs in one place"
echo "   • See which files need syncing"
echo ""
