...
echo "   gemini \"Create a [describe your AI system] using the MADIO framework\""
echo ""
echo "   🎯 Let MADIO choose templates:"
echo "   gemini \"I want to create [your idea]. Use MADIO templates based on complexity.\""
echo ""
echo "   🎯 Examples:"
echo "   gemini \"Create a customer support bot using MADIO with friendly personality\""
echo "   gemini \"Create a content writing AI using MADIO with SEO optimization\""
echo "   gemini \"Create a data analysis AI using MADIO with evaluation frameworks\""
echo ""
